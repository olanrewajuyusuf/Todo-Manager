...
const ActiveTask = ({data, handleShowSubtasks, handleTaskUpdate, arrowRotation, showSubtasks, handleTaskDelete, getSpecificDay, handleDrag}) => {

  const taskUnarked = data.filter(task => !task.completed);

  return (
    <div className="todo-lists">
        {taskUnarked.length === 0 && <p>No Active Task</p>}
        {taskUnarked.map(task => (
