...
const AllTasks = ({data, handleShowSubtasks, handleTaskUpdate, arrowRotation, showSubtasks, handleTaskDelete, getSpecificDay, handleDrag}) => {
  return (
    <div className="todo-lists">
        {data.length === 0 && <p>No Available Task</p>}
        {data.map(task => (
